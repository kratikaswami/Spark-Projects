...
def loadMovieNames():
    movieNames = {}
    with open("/home/kratika/Desktop/spark/ml-100k/u.item", encoding = 'ascii',errors = 'ignore') as f:
        for line in f:
            fields = line.split('|')
...
conf = SparkConf().setMaster("local[*]").setAppName("Movies with similar ratings")
sc = SparkContext(conf = conf)

print("LOADING MOVIE NAMES.")
nameDict = loadMovieNames()
data = sc.textFile("/home/kratika/Desktop/spark/ml-100k/u.data")
